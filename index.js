...
$("#dataTable").ready(function () {
    ...
    getAll().then(response => {
        ...
        for(var i = 0; i <response.length; i++){
            ...
            td2.innerHTML = response[i].namapemesan
            td3.innerHTML = response[i].namabarang
            td4.innerHTML = response[i].size
            td5.innerHTML = response[i].alamatlengkap
            td6.innerHTML = response[i].notelepon
            td7.innerHTML = response[i].jumlahpesanan
            td8.innerHTML = `<div class ="justify content-center">
